...
p4 <- plot_grid(plotlist = list(as.ggplot(exp1.arm.smoothcn.heatmap), arm.sensitivity.mad, p3, plot.placeholder), ncol = 1, labels = c("A.", "B."), rel_heights = c(4,2,2,3), label_size = 12, scale = c(0.95, 0.95, 1, 1))
