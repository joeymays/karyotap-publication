...
ggplot(combined.results, aes(x = feature.id, y = delta.acc)) +
    ...
    geom_text(aes(y = 28, label = sprintf("%+2d", combined.results$delta.probes)), size = 7/.pt) +
...
ggplot(exp4.gmm.metrics, aes(x = feature.id, y = true.pos.p)) +
    ...
    labs(x = "Chromosome", y = "Simulated Sensitivity (%)") +
...
ggplot(exp4.gmm.metrics, aes(x=n.probes, y=true.pos.p, color = cn.sim.class)) +
    ...
    labs(x = "Number of Probes", y = "Simulated Sensitivity (%)", color = "Copy Number") +
...
ggplot(sensitivity.compare.avg, aes(x = mean.tpr1, y = mean.tpr4, color = cn.sim.class, label = cn.sim.class.label)) +
    ...
    labs(x = "Panel Version 1\nMean Simulated Sensitivity (%)", y = "Panel Version 2\nMean Simulated Sensitivity (%)")
sensitivity.compare.plot
``` 
...
ggplot(exp4.gmm.specificity, aes(x = feature.id, y = tnr)) +
    ...
    theme(legend.position = "none", panel.grid.major.y = element_line(), 
          strip.background = element_blank()) +
    scale_fill_manual(values = c("#785EF0", "#648FFF", "#DC267F", "#FE6100", "#FFB000")) +
    labs(x = "Chromosome", y = "Simulated Specificity (%)") +
...
ggplot(exp4.gmm.metrics.3.spec, aes(x=n.probes, y=tnr, color = cn.sim.class)) +
    ...
    labs(x = "Number of Probes", y = "Simulated Specificity (%)", color = "Copy Number") +
...
ggplot(exp4.gmm.metrics.arms, aes(x = feature.id, y = true.pos.p)) +
    ...
    scale_fill_manual(values = c("#785EF0", "#648FFF", "#DC267F", "#FE6100", "#FFB000")) +
    labs(x = "Chromosome Arm", y = "Simulated Sensitivity (%)") +
    scale_y_continuous(breaks = c(0, 50, 100), expand = c(0,0,0,10)) +
    scale_x_discrete(labels = rpe1.data.arm.results$feature.label) +
    geom_hline(yintercept = 0) +
...
tpr.arms.bars.compare <- 
    ...
    scale_fill_viridis_d() +
    labs(x = "Chromosome Arm", y = "\u0394 Simulated Sensitivity (pp)") +
...
ggplot(sensitivity.compare.arms, aes(x=feature.id, y=delta.tpr, color = cn.sim.class)) +
    ...
    scale_color_viridis_d(labels = 1:5) +
    labs(y = "\u0394 Simulated Sensitivity (pp)", x = "Chromosome Arm", color = "Copy Number")
tpr.arms.dots.compare
```
...
ggplot(sensitivity.compare.arms, aes(x=delta.probes, y=delta.tpr, color = cn.sim.class)) +
    ...
    theme(legend.position = "top") +
    scale_color_viridis_d(labels = 1:5) +
    labs(y = "\u0394 Simulated Sensitivity (pp)", x = "\u0394 Number of Probes", color = "Copy Number") +
