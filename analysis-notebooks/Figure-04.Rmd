...
p3 <- plot_grid(plotlist = list(p2, plot.regression, plot.placeholder, plot.placeholder), ncol = 1, rel_heights = c(1, 0.8, 1, 0.7), labels = c("", "C.", ""), 
                label_size = 12, scale = c(1, 0.95, 0.95))
cowplot::plot_grid(plotlist = list(plot.placeholder, p3), labels = "Figure 4", label_size = 12, ncol = 1, rel_heights = c(1,40), hjust = -0.05)
```
