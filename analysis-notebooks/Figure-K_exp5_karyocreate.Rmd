...
fisher.result.figure$pval[fisher.result.figure$pval > 0.2] <- ""
```
...
```{r}
write.table(fisher.result.table, file = here("datasets", "exp05.fisher.results.txt"), quote = F, sep = "\t", row.names = F, col.names = T)
```
