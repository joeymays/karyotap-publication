...
rowData(exp1.subset)[rowData(exp1.subset)$median.reads <= 5,]
```
```{r}
exp1.subset <- exp1.subset[rowData(exp1.subset)$median.reads > 5,] #8 filtered for exp 1
```
...
```{r}
exp1.subset <- calcSmoothCopyNumber(exp1.subset, method = "weighted.median", control.copy.number = control.copy.number)
