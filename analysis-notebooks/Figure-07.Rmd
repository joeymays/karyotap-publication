...
p4 <- plot_grid(plotlist = list(plot.placeholder, plot.placeholder), labels = c(), ncol = 2, scale = 0.95, label_size = 12)
p5 <- plot_grid(plotlist = list(p2, rpe1.arm.sensitivity.mad, rpe1.arm.sensitivity.change, p4, plot.placeholder), ncol = 1, rel_heights = c(1.5, 0.75, 0.75, 1.5, 1.5), labels = c("", "C.", "D.", ""), scale = c(1, 0.95, 0.95, 1, 1), label_size = 12)
